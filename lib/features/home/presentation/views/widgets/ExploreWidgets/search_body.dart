...
class SearchBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListOfSearchProductItem(products: products, cubit: cubit);
  }
}

class ListOfSearchProductItem extends StatelessWidget {
  const ListOfSearchProductItem({
    super.key,
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            return CustomProductItem(
              onTap: () {
                NavigatorMethods.push(context: context, nextPage: ProductView(product: products[index]));
                cubit.search.clear();
